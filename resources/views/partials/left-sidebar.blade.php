    ...
    <div class="container pl-0 pr-0">
        <div class="nav-content">
            ...
            <ul class="mb-3">
                ...
                <li><a href="{{route('home')}}" class="nav-content-bttn open-font" data-tab="chats"><i class="feather-tv mr-3"></i><span>Accueil</span></a></li>
            ...
            <ul class="mb-3">
                ...
                <li><a href="default-settings.html" class="nav-content-bttn open-font h-auto pt-2 pb-2"><i class="font-sm feather-settings mr-3 text-grey-500"></i><span>Paramètres</span></a></li>
